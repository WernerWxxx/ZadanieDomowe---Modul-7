...
with st.sidebar:
    ...
    edu_level = st.selectbox("Wiek", ['Podstawowe', 'Średnie', 'Wyższe'])
...
st.subheader("Znajomi w tej samej grupie:")
st.dataframe(same_cluster_df[['age', 'edu_level', 'fav_animals', 'fav_place', 'gender']])
